...
Eldele, E.; Chen, Z.; Liu, C.; Wu, M.; Kwoh, C.-K.; Li, X.;and Guan, C.  2021a.
An attention-based deep learning ap-proach for sleep stage classification with single-channel eeg.
IEEE  Transactions  on  Neural  Systems  and  RehabilitationEngineering29:809–818.
'''
...
class BaseTrainer:
    ...
    """
    def __init__(self, model, criterion_1, criterion_2, metric_ftns, optimizer, config, fold_id):
        self.config = config
